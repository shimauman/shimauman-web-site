...
export default function SpasCurryMusicStreamingAnimationThumbnail({ location }) {
  const workElement = (
    <div className="w-full" style={{ aspectRatio: "16 / 9" }}>
      <iframe className="w-full h-full" width="640" height="360" src="https://www.youtube.com/embed/rL4M3cXNKRY?controls=0" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
    </div>
  )
